...
__decorate([
    ...
    __metadata("design:type", String)
], CreateLaboratorioDto.prototype, "correo", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.Length)(11, 11, { message: 'El RUC debe tener exactamente 11 dígitos' }),
    (0, class_validator_1.Matches)(/^[0-9]+$/, { message: 'El RUC debe contener solo números' }),
    __metadata("design:type", String)
], CreateLaboratorioDto.prototype, "ruc", void 0);
