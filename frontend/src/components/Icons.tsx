// Componente de iconos SVG para el sistema
...
export const PillIcon: React.FC<IconProps> = ({ className, size = 24 }) => (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="m15 9-6 6" />
        <path d="M13.5 3.5 14 3a2 2 0 0 1 2.828 0l2.829 2.828A2 2 0 0 1 20 8.657l-.5.5" />
        <path d="M9 13a2 2 0 0 0 0 2.828l4.243 4.243a2 2 0 0 0 2.828 0l3.586-3.586a2 2 0 0 0 0-2.828l-4.243-4.243a2 2 0 0 0-2.828 0L9 13Z" />
    </svg>
);
